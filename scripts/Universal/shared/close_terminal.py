...
``Setup_and_Run-audiobook-creation-tool.command`` (fast path) runs this AFTER the GUI has been spawned
...
def main() -> int:
    # Windows uses the .bat launcher and never calls this; do nothing off macOS.
