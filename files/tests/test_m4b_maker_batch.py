...
def test_the_maker_panel_now_runs_through_this_module():
    """Phase 5 built the runner behind an untouched panel; Phase 6 made the panel
    ...
    assert "m4b_maker_batch" in panel.read_text(encoding="utf-8")
