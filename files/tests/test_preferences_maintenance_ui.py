...
#: Four since the focused MP3 plan's Phase 4 converted the MP3 Tool, and
#: three since v0.6.4 Phase 6 converted the M4B Maker: both now name the
#: design system deliberately, like the M4B Metadata Editor.
UNCONVERTED_PANELS = (
...
def test_the_three_unconverted_panels_still_carry_no_act_style():
