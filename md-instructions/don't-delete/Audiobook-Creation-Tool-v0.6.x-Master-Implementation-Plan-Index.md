...
OPEN). This is the current §5 status.** It supersedes the 2026-09-07 note below on exactly one point:
...
**Updated 2026-09-13, at the pre-merge documentation reconciliation for pull request #10. This block is
the current next-action record. It supersedes the 2026-09-07 block below it on every point that
